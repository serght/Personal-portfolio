      ...
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 
            ...
            4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 
            4.948.072 3.259 0 3.668-.014 4.948-.072 
            ...
            0-2.209 1.791-4 4-4s4 1.791 4 
            4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 
            0-1.441.645-1.441 1.44s.645 1.44 1.441 
            1.44c.795 0 1.439-.645 
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          .319.192.694.801.576C20.565 21.798 24 
          17.301 24 12c0-6.627-5.373-12-12-12z" />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          1.637-1.85 3.37-1.85 
          3.601 0 4.267 2.37 4.267 
          5.455v6.286zM5.337 7.433c-1.144 
          0-2.063-.926-2.063-2.065 
          ...
          0H1.771C.792 0 0 .774 
          0 1.729v20.542C0 23.227.792 
      ...
      <div className="container mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {contactMethods.map((method, index) => (
            ...
            >
              <div
                className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 ${method.iconColor} ${
                  isDayMode ? "bg-white shadow-md" : "bg-white/10 backdrop-blur-sm"
